  ...
  return (
    <Card className="p-5">
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-sm font-semibold text-slate-700 dark:text-slate-300">Client portal link</h2>
      </div>
      <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
        One link, no login needed — your client can check progress, upcoming milestones, payment claim status, and
        approve any variations awaiting them, whenever they like.
      </p>
      {!link ? (
